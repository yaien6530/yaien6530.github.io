import{_ as e,X as s,Y as a,a0 as t,Z as n,$ as i,a2 as l}from"./framework-4115b8f2.js";const d={},o=n("h1",{id:"spring-基础-二",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#spring-基础-二","aria-hidden":"true"},"#"),i(" Spring 基础（二）")],-1),c=n("p",null,"Spring 基础笔记系列",-1),u=l(`<h2 id="对象的作用域与生命周期-不常用" tabindex="-1"><a class="header-anchor" href="#对象的作用域与生命周期-不常用" aria-hidden="true">#</a> 对象的作用域与生命周期（不常用）</h2><p>由Spring管理的对象，默认都是单例的！并且，都是饿汉式的单例模式。</p><p>在配置<code>&lt;bean&gt;</code>节点时，可以添加<code>scope</code>属性其是否单例，当取值为<code>singleton</code>时表示单例，该值也是默认值，当取值为<code>prototype</code>时表示非单例：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;bean id=&quot;user&quot; class=&quot;cn.tedu.spring.User&quot; scope=&quot;prototype&quot;/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在单例模式的基础之上，还可以通过<code>lazy-init</code>属性配置它是否为懒汉式的单例模式，默认值为<code>false</code>，即非懒汉式，也就是饿汉式的单例模式，当取值为<code>true</code>时，表示懒汉式的单例模式：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;bean id=&quot;user&quot;
      class=&quot;cn.tedu.spring.User&quot;
      scope=&quot;singleton&quot;
      lazy-init=&quot;true&quot;/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果某个类被配置为单例模式，还可以配置它的生命周期方法：首先，在类中声明2个方法，这2个方法都应该是<code>public</code>方法，返回值都是<code>void</code>，方法名称可以自由定义，方法必须没有参数，例如：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>	<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">init</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，在Spring的配置文件中，在<code>&lt;bean&gt;</code>节点中配置<code>init-method</code>和<code>destroy-method</code>属性，即可配置初始化方法和销毁方法，这2个属性的取值都是需要调用的方法的名称：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;bean id=&quot;user&quot;
      class=&quot;cn.tedu.spring.User&quot;
      scope=&quot;singleton&quot;
      lazy-init=&quot;true&quot;
      init-method=&quot;init&quot;
      destroy-method=&quot;destroy&quot;/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="spring的ioc" tabindex="-1"><a class="header-anchor" href="#spring的ioc" aria-hidden="true">#</a> Spring的IoC</h2><h3 id="什么是ioc" tabindex="-1"><a class="header-anchor" href="#什么是ioc" aria-hidden="true">#</a> 什么是IoC</h3><p>IoC表示Inversion of control，即“控制反转”。传统模式下，对象的创建与管理都是由开发人员编写代码直接完成的，而使用Spring后，将创建与管理交给了框架，则称之为控制反转。</p><p>其中，比较重要的环节是为对象的某些属性进行赋值，称之为DI，即Dependency Injection，表示“依赖注入”，通俗的来说，是为其属性赋值，也称之为“为其属性注入值”。</p><p>Spring通过DI实现了IoC，即DI是实现手段，而IoC是需要实现的目标。</p><h3 id="通过set方式注入属性的值" tabindex="-1"><a class="header-anchor" href="#通过set方式注入属性的值" aria-hidden="true">#</a> 通过SET方式注入属性的值</h3><p>假设<code>User</code>类中有名为<code>name</code>的属性，需要为该属性注入值，首先，需要为该属性添加SET/GET方法(其实只有SET方法是必须的)：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>	<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">setName</span><span class="token punctuation">(</span><span class="token class-name">String</span> name<span class="token punctuation">)</span> <span class="token punctuation">{</span>
		<span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
	<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，在<code>&lt;bean&gt;</code>节点子级添加<code>&lt;property&gt;</code>节点进行配置：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;bean id=&quot;user&quot;
      class=&quot;cn.tedu.spring.User&quot;&gt;
    &lt;!-- 使用property节点为属性注入值 --&gt;
    &lt;!-- name：属性名 --&gt;
    &lt;!-- value：属性值 --&gt;
...
&lt;/bean&gt;
    ...
    &lt;/property&gt;
&lt;/bean&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果需要注入<code>Set</code>类型的值，例如：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>	<span class="token comment">// Beijing, Shanghai, Guangzhou, Shenzhen</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>在配置注入时，使用<code>&lt;set&gt;</code>节点即可：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;property name=&quot;cities&quot;&gt;
    &lt;set&gt;
        &lt;value&gt;Beijing&lt;/value&gt;
    ...
    &lt;/set&gt;
&lt;/property&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>另外，关于<code>Map</code>类型集合的配置例如：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;property name=&quot;session&quot;&gt;
    &lt;map&gt;
    ...
    &lt;/map&gt;
&lt;/property&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>关于数组类型集合的配置例如：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;property name=&quot;numbers&quot;&gt;
    &lt;array&gt;
        &lt;value&gt;9&lt;/value&gt;
        &lt;value&gt;5&lt;/value&gt;
        &lt;value&gt;2&lt;/value&gt;
    ...
    &lt;/array&gt;
&lt;/property&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>在配置数组时，也可以使用<code>&lt;list&gt;</code>节点，反之，在配置<code>List</code>集合时，也可以使用<code>&lt;array&gt;</code>节点，但是，推荐使用匹配的节点进行配置。</p></blockquote><p>关于<code>Properties</code>类型的配置：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;property name=&quot;config&quot;&gt;
    &lt;props&gt;
    ...
    &lt;/props&gt;
&lt;/property&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在配置以上集合类型的值时，也可以事先使用例如<code>&lt;util:list&gt;</code>这类节点先将值配置好：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;util:list id=&quot;names&quot;&gt;
    &lt;value&gt;Tom&lt;/value&gt;
    &lt;value&gt;Alex&lt;/value&gt;
    &lt;value&gt;Lucy&lt;/value&gt;
    &lt;value&gt;Kitty&lt;/value&gt;
    &lt;value&gt;Henry&lt;/value&gt;
&lt;/util:list&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后再注入到属性中：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;property name=&quot;names&quot; ref=&quot;names&quot;/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>比较特殊的是读取<code>Properties</code>类型的数据，在Spring中，可以通过<code>&lt;util:properties&gt;</code>节点的<code>location</code>属性指定需要读取的文件：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;util:properties id=&quot;config&quot;
                 location=&quot;classpath:db.properties&quot;/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，就可以注入到相应的属性中：</p><div class="language-xm line-numbers-mode" data-ext="xm"><pre class="language-xm"><code>&lt;property name=&quot;config&quot; ref=&quot;config&quot;/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,54);function p(r,v){return s(),a("div",null,[o,c,t(" more "),u])}const g=e(d,[["render",p],["__file","2101202011.html.vue"]]);export{g as default};
