import{_ as e,r as t,o as i,c as o,d as l,a as n,b as s,f as p,e as c}from"./app-4f9dbd97.js";const u={},r=n("h1",{id:"索引优化实战",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#索引优化实战","aria-hidden":"true"},"#"),s(" 索引优化实战")],-1),d=n("p",null,"MYSQL 索引优化实战笔记",-1),v=c(`<h2 id="优化实战" tabindex="-1"><a class="header-anchor" href="#优化实战" aria-hidden="true">#</a> 优化实战</h2><h3 id="联合索引第一个字段用范围不会走索引" tabindex="-1"><a class="header-anchor" href="#联合索引第一个字段用范围不会走索引" aria-hidden="true">#</a> 联合索引第一个字段用范围不会走索引</h3><p>mysql内部优化规则可能会觉得第一个字段就用范围，结果集应该很大，回表效率不高，还不知直接全表扫</p><h3 id="强制走索引" tabindex="-1"><a class="header-anchor" href="#强制走索引" aria-hidden="true">#</a> 强制走索引</h3><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token comment">-- 语句</span>
...
</code></pre></div><p>添加强制索引可以让语句走索引，但是最总查找的效率不一定会比扫全表高，因为回表效率不高</p><h3 id="覆盖索引优化" tabindex="-1"><a class="header-anchor" href="#覆盖索引优化" aria-hidden="true">#</a> 覆盖索引优化</h3><p>对于不走索引的语句，可以尝试使用覆盖索引来进行优化</p><h3 id="in和or在表数据大会走索引-反之不会" tabindex="-1"><a class="header-anchor" href="#in和or在表数据大会走索引-反之不会" aria-hidden="true">#</a> in和or在表数据大会走索引，反之不会</h3><h3 id="like语句一般情况下都会走索引" tabindex="-1"><a class="header-anchor" href="#like语句一般情况下都会走索引" aria-hidden="true">#</a> like语句一般情况下都会走索引</h3><p>like语句看着其实跟大于小于号差不多，之所以会走索引是因为用到了<strong>索引下推</strong></p><h2 id="索引下推" tabindex="-1"><a class="header-anchor" href="#索引下推" aria-hidden="true">#</a> 索引下推</h2><p>联合索引是按照最左前缀原则来进行匹配，正常情况下联合索引首个字段就使用like，那只会匹配到这个字段， 后面的因为不能确保是有序的就无法再利用索引。</p><p>5.6版本以前，首个字段就停止索引匹配，那就会拿这些对应索引的主键逐个回表找数据，再比对后序字段是否符合。5.6对此进行优化，在索引便利过程中，对索引中包含的字段先做判断，过滤掉不符合条件的记录之后再回表，可以有效的减少回表次数。这就是索引下推。</p><blockquote><p>索引下推回减少回表次数，对于innodb引擎只能适用于二级索引，对主键索引并不适用</p></blockquote><h2 id="trace工具" tabindex="-1"><a class="header-anchor" href="#trace工具" aria-hidden="true">#</a> trace工具</h2><p>trace</p><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token comment">-- 开启trace</span>
...
</code></pre></div><p>结果集</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>{
        ...
        <span class="token string">&quot;steps&quot;</span>: <span class="token punctuation">[</span>
          {
            <span class="token string">&quot;condition_processing&quot;</span>: {
              ...
              <span class="token string">&quot;original_condition&quot;</span>: <span class="token string">&quot;(\`t_menu\`.\`menu_name\` &gt; &#39;a&#39;)&quot;</span><span class="token punctuation">,</span>
              <span class="token string">&quot;steps&quot;</span>: <span class="token punctuation">[</span>
                {
                  ...
                  <span class="token string">&quot;resulting_condition&quot;</span>: <span class="token string">&quot;(\`t_menu\`.\`menu_name\` &gt; &#39;a&#39;)&quot;</span>
                }<span class="token punctuation">,</span>
                {
          ...
          }<span class="token punctuation">,</span>
          {
            <span class="token string">&quot;table_dependencies&quot;</span>: <span class="token punctuation">[</span>
              ...
              {
                <span class="token string">&quot;table&quot;</span>: <span class="token string">&quot;\`t_menu\`&quot;</span><span class="token punctuation">,</span>
              ...
              <span class="token comment">/* 预估表的访问成本 */</span>
              {
                ...
                <span class="token string">&quot;range_analysis&quot;</span>: {
                  <span class="token string">&quot;table_scan&quot;</span>: {
                    ...
                    <span class="token string">&quot;rows&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
                    <span class="token comment">/* 扫描行数 */</span>
                    <span class="token string">&quot;cost&quot;</span>: <span class="token number">6.1</span>
                  ...
                  <span class="token string">&quot;potential_range_indexes&quot;</span>: <span class="token punctuation">[</span>
                    ...
                    {
                      <span class="token string">&quot;index&quot;</span>: <span class="token string">&quot;idx_test&quot;</span><span class="token punctuation">,</span>
                    ...
                    <span class="token string">&quot;range_scan_alternatives&quot;</span>: <span class="token punctuation">[</span>
                      {
                        ...
                        <span class="token string">&quot;rows&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
                        <span class="token comment">/* 扫描行数 */</span>
                        <span class="token string">&quot;cost&quot;</span>: <span class="token number">19.01</span><span class="token punctuation">,</span>
            ...
            <span class="token string">&quot;considered_execution_plans&quot;</span>: <span class="token punctuation">[</span>
              {
                ...
                <span class="token string">&quot;best_access_path&quot;</span>: {
                  ...
                  <span class="token string">&quot;considered_access_paths&quot;</span>: <span class="token punctuation">[</span>
                    ...
                    {
                      <span class="token string">&quot;rows_to_scan&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
                      ...
                      <span class="token string">&quot;resulting_rows&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
                      <span class="token string">&quot;cost&quot;</span>: <span class="token number">4</span><span class="token punctuation">,</span>
                      <span class="token string">&quot;chosen&quot;</span>: <span class="token boolean">true</span><span class="token punctuation">,</span>
                ...
                <span class="token string">&quot;rows_for_plan&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
                <span class="token string">&quot;cost_for_plan&quot;</span>: <span class="token number">4</span><span class="token punctuation">,</span>
                <span class="token string">&quot;sort_cost&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
                <span class="token string">&quot;new_cost_for_plan&quot;</span>: <span class="token number">19</span><span class="token punctuation">,</span>
          ...
          }<span class="token punctuation">,</span>
          {
            <span class="token string">&quot;attaching_conditions_to_tables&quot;</span>: {
              ...
              <span class="token string">&quot;attached_conditions_summary&quot;</span>: <span class="token punctuation">[</span>
                {
                  <span class="token string">&quot;table&quot;</span>: <span class="token string">&quot;\`t_menu\`&quot;</span><span class="token punctuation">,</span>
                  <span class="token string">&quot;attached&quot;</span>: <span class="token string">&quot;(\`t_menu\`.\`menu_name\` &gt; &#39;a&#39;)&quot;</span>
                }
              <span class="token punctuation">]</span>
          ...
          }<span class="token punctuation">,</span>
          {
            <span class="token string">&quot;clause_processing&quot;</span>: {
              ...
              <span class="token string">&quot;original_clause&quot;</span>: <span class="token string">&quot;\`t_menu\`.\`parent_id\`&quot;</span><span class="token punctuation">,</span>
              <span class="token string">&quot;items&quot;</span>: <span class="token punctuation">[</span>
                {
                  <span class="token string">&quot;item&quot;</span>: <span class="token string">&quot;\`t_menu\`.\`parent_id\`&quot;</span>
                }
              <span class="token punctuation">]</span>
              ...
              <span class="token string">&quot;resulting_clause&quot;</span>: <span class="token string">&quot;\`t_menu\`.\`parent_id\`&quot;</span>
            }
          ...
          }<span class="token punctuation">,</span>
          {
            <span class="token string">&quot;refine_plan&quot;</span>: <span class="token punctuation">[</span>
              {
                <span class="token string">&quot;table&quot;</span>: <span class="token string">&quot;\`t_menu\`&quot;</span>
              }
            <span class="token punctuation">]</span>
        ...
        <span class="token string">&quot;steps&quot;</span>: <span class="token punctuation">[</span>
          {
            <span class="token string">&quot;filesort_information&quot;</span>: <span class="token punctuation">[</span>
              {
                ...
                <span class="token string">&quot;table&quot;</span>: <span class="token string">&quot;\`t_menu\`&quot;</span><span class="token punctuation">,</span>
                <span class="token string">&quot;field&quot;</span>: <span class="token string">&quot;parent_id&quot;</span>
              }
            <span class="token punctuation">]</span>
            ...
            <span class="token string">&quot;filesort_summary&quot;</span>: {
              ...
              <span class="token string">&quot;examined_rows&quot;</span>: <span class="token number">15</span><span class="token punctuation">,</span>
              <span class="token comment">/* 参与排序行 */</span>
              <span class="token string">&quot;number_of_tmp_files&quot;</span>: <span class="token number">0</span><span class="token punctuation">,</span>
              <span class="token comment">/* 使用临时文件个数，如果为0表示全部用sort_puffer内存排序 */</span>
              <span class="token string">&quot;sort_buffer_size&quot;</span>: <span class="token number">14656</span><span class="token punctuation">,</span>
