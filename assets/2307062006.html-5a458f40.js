...
jobs:
  ...
  deploy-server:
    ...
    steps:
      ...
      - name: Deploy
        run: <span class="token operator">|</span>
          <span class="token function">ssh</span> root@yanggl.cn <span class="token string">&quot;git config --global --add safe.directory /www/wwwroot/yaien&quot;</span>
          <span class="token function">ssh</span> root@yanggl.cn <span class="token string">&quot;cd /www/wwwroot/yaien&quot;</span>
          <span class="token function">git</span> push <span class="token parameter variable">-f</span> root@yanggl.cn:/www/wwwroot/yaien blog
          <span class="token function">ssh</span> root@yanggl.cn <span class="token string">&quot;cd /www/wwwroot/yaien &amp;&amp; git checkout blog &amp;&amp; git reset --hard HEAD&quot;</span>

      - name: Copy to dist
        run: <span class="token operator">|</span>
          <span class="token function">ssh</span> root@yanggl.cn <span class="token string">&quot;rsync -avz --delete /www/wwwroot/yaien/ /usr/share/nginx/html/&quot;</span>

      - name: Reset
        run: <span class="token operator">|</span>
          <span class="token function">ssh</span> root@yanggl.cn <span class="token string">&quot;cd /www/wwwroot &amp;&amp; rm -rf yaien/ &amp;&amp; mkdir yaien &amp;&amp; cd yaien &amp;&amp; git init&quot;</span>
