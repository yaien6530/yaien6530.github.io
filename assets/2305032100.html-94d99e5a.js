import{_ as e,E as t,U as o,a5 as p,a6 as n,a7 as s,X as i,a8 as l}from"./framework-a4fc28af.js";const c={},r=l(`<h1 id="索引优化实战" tabindex="-1"><a class="header-anchor" href="#索引优化实战" aria-hidden="true">#</a> 索引优化实战</h1><p>MYSQL 索引优化实战笔记</p><h2 id="优化实战" tabindex="-1"><a class="header-anchor" href="#优化实战" aria-hidden="true">#</a> 优化实战</h2><h3 id="_1-联合索引第一个字段用范围不会走索引" tabindex="-1"><a class="header-anchor" href="#_1-联合索引第一个字段用范围不会走索引" aria-hidden="true">#</a> 1.联合索引第一个字段用范围不会走索引</h3><p>mysql内部优化规则可能会觉得第一个字段就用范围，结果集应该很大，回表效率不高，还不知直接全表扫</p><h3 id="_2-强制走索引" tabindex="-1"><a class="header-anchor" href="#_2-强制走索引" aria-hidden="true">#</a> 2.强制走索引</h3><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token comment">-- 语句</span>
