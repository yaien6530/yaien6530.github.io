import{_ as n,U as a,a5 as t,a8 as s}from"./framework-a4fc28af.js";const e={},o=s(`<h1 id="spring-基础-二" tabindex="-1"><a class="header-anchor" href="#spring-基础-二" aria-hidden="true">#</a> Spring 基础（二）</h1><p>Spring 基础笔记系列</p><h2 id="对象的作用域与生命周期-不常用" tabindex="-1"><a class="header-anchor" href="#对象的作用域与生命周期-不常用" aria-hidden="true">#</a> 对象的作用域与生命周期（不常用）</h2><p>由Spring管理的对象，默认都是单例的！并且，都是饿汉式的单例模式。</p><p>在配置<code>&lt;bean&gt;</code>节点时，可以添加<code>scope</code>属性其是否单例，当取值为<code>singleton</code>时表示单例，该值也是默认值，当取值为<code>prototype</code>时表示非单例：</p><div class="language-xm" data-ext="xm"><pre class="language-xm"><code>&lt;bean id=&quot;user&quot; class=&quot;cn.tedu.spring.User&quot; scope=&quot;prototype&quot;/&gt;
...
</code></pre></div>`,56),p=[o];function l(c,i){return a(),t("div",null,p)}const d=n(e,[["render",l],["__file","2101202011.html.vue"]]);export{d as default};
