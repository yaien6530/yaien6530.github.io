import{_ as s,X as a,Y as t,a0 as p,Z as n,$ as e,a2 as o}from"./framework-1502171d.js";const c={},i=n("h1",{id:"栈结构-数组实现",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#栈结构-数组实现","aria-hidden":"true"},"#"),e(" 栈结构（数组实现）")],-1),l=n("p",null,"栈（Stack）是一种线性数据结构，它具有后进先出（Last-In-First-Out，LIFO）的特性。这意味着最后一个进入栈中的元素是第一个被弹出的，而最先进入栈中的元素是最后一个被弹出的。",-1),u=o(`<h2 id="图形分析" tabindex="-1"><a class="header-anchor" href="#图形分析" aria-hidden="true">#</a> 图形分析</h2><figure><img src="https://img-blog.csdnimg.cn/20190927105556143.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDEwNDA5OQ==,size_16,color_FFFFFF,t_70" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure><h2 id="思路分析" tabindex="-1"><a class="header-anchor" href="#思路分析" aria-hidden="true">#</a> 思路分析</h2><pre><code>1. 定义一个top来表示入栈的数量（栈顶），当添加一个数据时top会指向新添加的数据；
...
</code></pre><h2 id="实现代码" tabindex="-1"><a class="header-anchor" href="#实现代码" aria-hidden="true">#</a> 实现代码</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">//定义一个 ArrayStack 表示栈结构</span>
